...
## A Brief Timeline
\footnotesize
In John Deere, I have had the fortune to work in multiple functions in various capacities. In these assignments, in addition to Pune factory, I could work with Dewas *(I relocated there)* and Sirhind factories while they were still being constructed.  
...
## Working with Data
Increasingly technology and data have become more accessible. Leveraging these offer tremendous opportunities in changing the way we work, bringing in a completely new paradigm, enabling us to ask questions and expect *reproducible and repeatable* answers to those questions.  
